...
const zd = require("../_zerodot");
const { sign, randomToken } = require("../../_jwt");
const { serializeCookie, appendCookie } = require("../../_cookies");
...
function fail(res, msg) {
  res.statusCode = 302;
  res.setHeader("Location", `/pages/login.html?error=${encodeURIComponent(msg)}`);
